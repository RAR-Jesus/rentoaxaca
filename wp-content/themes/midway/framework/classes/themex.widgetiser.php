...
class ThemexWidgetiser {
	...
	public static function renderSettings() {
		...
		//area name option
		$name_option=array(	'name' => __('Sidebar Name','midway'),
							'id' => 'themex_widgetiser_area_name',
							'type' => 'text',
							'after' => '<div class="themex_button add_sidebar">'.__('Add Sidebar','midway').'</div>');
		...
		if(is_array(self::$data)) {
			foreach(self::$data as $area_id=>$area) {
				...
				//area pages
				$out.='<div class="themex_left_col"><div class="themex_button add_page">'.__('Add Page','midway').'</div>';
				...
				//area categories
				$out.='<div class="themex_right_col"><div class="themex_button add_category">'.__('Add Category','midway').'</div>';
				...
				$out.='</div><div class="clear"><div class="themex_button remove_sidebar">'.__('Remove Sidebar','midway').'</div></div></div>';
	...
	public static function addArea() {
		...
		//server response
		echo '<div class="themex_section hidden" id="'.$area_id.'"><h3>'.$area_name.'</h3><div class="themex_left_col"><div class="themex_button add_page">'.__('Add Page','midway').'</div></div><div class="themex_right_col"><div class="themex_button add_category">'.__('Add Category','midway').'</div></div><div class="clear"><div class="themex_button remove_sidebar">'.__('Remove Sidebar','midway').'</div></div></div>';

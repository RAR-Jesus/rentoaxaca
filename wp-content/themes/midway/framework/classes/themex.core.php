	...
	public static function activate() {
		...
		if ('themes.php' == $pagenow && isset($_GET['activated'])) {
			...
			if(version_compare( PHP_VERSION, '5', '<')) {
				...
				wp_die(__('Your PHP version is too old, this theme requires PHP 5.0 and higher.','midway').'<br /><a href="'.admin_url( 'themes.php' ).'">'.__('Return to WP Admin','midway').' &larr;</a>');
			}

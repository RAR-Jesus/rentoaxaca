...
$date_dep=ThemexCore::getArrayValue($_GET,'date_dep',__('Departure Date','midway'));
$date_arr=ThemexCore::getArrayValue($_GET,'date_arr',__('Arrival Date','midway'));
	...
	<form role="search" method="get" id="searchform" action="<?php echo home_url(); ?>">
		...
		<div class="form-button">
			<div class="button-container">
				<a href="#" class="button submit"><span><?php _e('Search Tours','midway'); ?></span></a>
			</div>
		</div>					
		...
		<input type="hidden" class="date-day-1" value="<?php _e('Su', 'midway'); ?>" />
		<input type="hidden" class="date-day-2" value="<?php _e('Mo', 'midway'); ?>" />
		<input type="hidden" class="date-day-3" value="<?php _e('Tu', 'midway'); ?>" />
		<input type="hidden" class="date-day-4" value="<?php _e('We', 'midway'); ?>" />
		<input type="hidden" class="date-day-5" value="<?php _e('Th', 'midway'); ?>" />
		<input type="hidden" class="date-day-6" value="<?php _e('Fr', 'midway'); ?>" />
		<input type="hidden" class="date-day-7" value="<?php _e('Sa', 'midway'); ?>" />
		<input type="hidden" class="date-month-1" value="<?php _e('January', 'midway'); ?>" />
		<input type="hidden" class="date-month-2" value="<?php _e('February', 'midway'); ?>" />
		<input type="hidden" class="date-month-3" value="<?php _e('March', 'midway'); ?>" />
		<input type="hidden" class="date-month-4" value="<?php _e('April', 'midway'); ?>" />
		<input type="hidden" class="date-month-5" value="<?php _e('May', 'midway'); ?>" />
		<input type="hidden" class="date-month-6" value="<?php _e('June', 'midway'); ?>" />
		<input type="hidden" class="date-month-7" value="<?php _e('July', 'midway'); ?>" />
		<input type="hidden" class="date-month-8" value="<?php _e('August', 'midway'); ?>" />
		<input type="hidden" class="date-month-9" value="<?php _e('September', 'midway'); ?>" />
		<input type="hidden" class="date-month-10" value="<?php _e('October', 'midway'); ?>" />
		<input type="hidden" class="date-month-11" value="<?php _e('November', 'midway'); ?>" />
		<input type="hidden" class="date-month-12" value="<?php _e('December', 'midway'); ?>" />
	</form>

                ...
                <div class="blog-row">
                    ...
                    <div class="col-1-2">
                        ...
                        <div class="blog-box padd-25">
                            ...
                            <div class="blog-detail marg-y-50">
                                ...
                                <div class="blog-exc padd-x-25">
                                     <?php echo wp_trim_words( wp_strip_all_tags( strip_shortcodes(get_the_content()) ), $num_words = 30, $more = '...' ); ?>
                                </div>

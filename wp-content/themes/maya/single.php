...
// Post Metas
$post_meta = '<a href="'.get_author_posts_url( get_the_author_meta( 'ID' )).'">'.get_the_author_meta( 'display_name' ).'</a> / '.get_the_date().' / <a href="'.get_category_link($post_category->term_id).'">'.$post_category->name.'</a>';
...
<div class="blog-nav bg-fs-clr padd-25">
        ...
        <ul>
            ...
            <li class="blog-home brd-wh-clr wh-clr bg-wh-clr-hov fs-clr-hov">
            	<a href="<?php echo get_category_link($post_category->term_id); ?>"><i class="icon-menu"></i></a>
            </li>

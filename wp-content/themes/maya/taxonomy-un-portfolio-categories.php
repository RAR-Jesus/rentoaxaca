...
<div id="page" class="page">
    ...
    <div class="header-page marg-top-100 padd-y-75 bg-gr1-clr">
    	...
    	<div class="title-page padd-x-25 fs-clr"><?php single_cat_title(); ?></div>
                        ...
                        <div class="blog-detail padd-25">
                            ...
                            <div class="blog-meta">
                                <span class="blog-author"><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php the_author(); ?></a></span> / 
                     			<span class="blog-cat"><a href="<?php echo get_term_link( $post_category->term_id, 'un-portfolio-categories' ); ?>"><?php echo $post_category->name; ?></a></span>                   
                            </div>

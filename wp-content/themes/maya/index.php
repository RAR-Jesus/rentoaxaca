...
<div id="page" class="page">
    ...
    <div class="header-page marg-top-100 padd-y-75 bg-gr1-clr">
    	...
    	<div class="title-page padd-x-25 fs-clr"><?php _e('Blog', UN); ?></div>
    ...
    <div class="blog-content marg-y-50">
        ...
        <div class="boxed">
            ...
            <div class="col-1-3 transit-top<?php if(is_sticky()){ echo ' sticky_post'; } ?>">
                ...
                <div class="blog-box padd-25">
                    ...
                    <div class="blog-frame brd-fs-clr">
                        ...
                        <div class="blog-detail padd-25">
                            ...
                            <div class="line-center brd-gr2-clr"><?php if(is_sticky()){ echo '<i class="icon-star"></i>'; } ?></div>

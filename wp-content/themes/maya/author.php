...
<div id="page" class="page">
    ...
    <div class="header-page marg-top-100 padd-y-75 bg-gr1-clr">
    	...
    	<div class="title-page padd-x-25 fs-clr"><?php global $wp_query; $curauth = $wp_query->get_queried_object(); echo $curauth->display_name; ?></div>
    ...
    <div class="blog-content marg-y-50">
        ...
        <div class="boxed">
            ...
            <?php } }else{ ?>
                ...
                <div class="padd-top-100 padd-bott-200">
				
                	<div class="icon-404 fs-clr marg-bott-50"><i class="icon-loader"></i></div>
				
					<?php echo '<h3 class="center">'.__('The author has not published posts yet!', UN).'</h3>'; ?>
				
				</div>
				
			<?php } // Close Loop and have_posts ?>
